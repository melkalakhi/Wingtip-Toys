...
public class NVPAPICaller
{
    ...
    public string APIUsername = "mohammed.elkalakhi-facilitator_api1.gmail.com";
    private string APIPassword = "XZMX5393TKKUZ2HM";
    private string APISignature = "AVkS-tHU2h7x-Z4rkFdc48Ls6tx5ADahFylvy5987uLakNbd4Fg5tFEM";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (Wingtip_Toys.Logic.ShoppingCartActions myCartOrders = new Wingtip_Toys.Logic.ShoppingCartActions())
        {
